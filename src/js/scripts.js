document.addEventListener("DOMContentLoaded", function () {
  ...
  addOutputToTerminal('<hr/>'); // Divider line between experiences
      ...
      case "papers":
        ...
        addOutputToTerminal("2. Huffman Algorithm");
        addOutputToTerminal(
        ...
        addOutputToTerminal("3. An analysis on Vulnerability appraisals in web");
        addOutputToTerminal(
 ...
 addOutputToTerminal(downloadLink);
  addOutputToTerminal('<hr/>')
        ...
        addOutputToTerminal("4. Data mining Usage in CRM");
        addOutputToTerminal(
        ...
        addOutputToTerminal("5. Synergy of Blockchain");
        addOutputToTerminal(
